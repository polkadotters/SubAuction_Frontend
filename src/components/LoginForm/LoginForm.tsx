...
export const LoginForm: React.FC = () => {
  ...
  <form onSubmit={handleSubmit(onSubmit)}>
    ...
    <FormLabel htmlFor="email" size="lg">Email</FormLabel>
    <Input
      name="email"
      placeholder="email"
  ...
  <FormControl isInvalid={errors.password}>
    <FormLabel htmlFor="password" size="lg">Password</FormLabel>
    <Input
      name="password"
      type="password"
  ...
  <Button mt={4} colorScheme="teal" variant='link' type="button" disabled={state.fetching} onClick={() => setIsLogin(!isLogin)}>
