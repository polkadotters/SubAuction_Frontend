...
export const CreateForm: React.FC = () => {
  ...
  const onSubmit = ({ title, startPrice, duration }: Auction) => {
    console.log('data', typeof title, typeof parseInt(price));
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={6}>
          <FormControl isInvalid={errors.title}>
            <FormLabel htmlFor="title" size="lg">
              Title
            </FormLabel>
            <Input
              name="title"
          ...
          <FormControl isInvalid={errors.price}>
            <FormLabel htmlFor="price" size="lg">
              Price
            </FormLabel>
            <Input
              name="startPrice"
          ...
          <FormControl isInvalid={errors.duration}>
            <FormLabel htmlFor="duration" size="lg">
              Duration (in hours)
            </FormLabel>
            <Input
              name="duration"
